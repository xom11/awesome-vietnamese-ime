...
Số liệu ★, lần push cuối và giấy phép do GitHub Action sinh lại hàng tuần từ [`data/ime.json`](data/ime.json). Vài giấy phép GitHub đọc không ra thì khai tay, có ghi rõ trong [CONTRIBUTING.md](CONTRIBUTING.md) (chốt lần cuối: 2026-09-07).
...
| Hệ điều hành | Gợi ý |
|---|---|
| macOS | 🟢 [Gõ Nhanh](https://gonhanh.org) 755★ · 🟢 [XKey](https://github.com/xmannv/xkey) 496★ |
| Windows | 🟢 [VKey](https://github.com/phatMT97/VKey) 175★ · 📦 [VietType](https://github.com/dinhngtu/VietType) 55★ · ⚫ [UniKey](https://www.unikey.org) |
| Linux | 🟢 [Fcitx5 Lotus](https://lotusinputmethod.github.io/) 476★ · 🟢 [IBus Bamboo](https://github.com/BambooEngine/ibus-bamboo) 1497★ · 🟢 [VnKey](https://vnkey.app) 102★ |
...
|---|---:|---|---|---|
| [Gõ Nhanh](https://gonhanh.org) | 755 | 🟢 2026-09 | BSD-3-Clause | Bộ gõ macOS viết Rust, tối ưu <10ms độ trễ, tự nhớ chế độ gõ theo từng app. |
| [XKey](https://github.com/xmannv/xkey) | 496 | 🟢 2026-09 | MIT | Bộ gõ macOS viết Swift, nhiều tính năng: macro, từ điển, dịch nhanh 30+ ngôn ngữ. |
| [Gõkey](https://github.com/huytd/goxkey) | 282 | 🟢 2026-08 | BSD-3-Clause | Bộ gõ macOS viết Rust, tối giản, không có tính năng nào ngoài gõ tiếng Việt. |
| [PHTV](https://phamhungtien.com/PHTV/) | 166 | 🟢 2026-09 | AGPL-3.0 | Bộ gõ macOS chú trọng riêng tư, xử lý cục bộ, đang mở rộng sang Windows/Linux. |
...
| [VietTelex](https://viettelex.com) | 54 | 🟢 2026-09 | MIT | Input method IMKit thật của macOS, không gạch chân, gõ được cả trong Terminal. |
...
| Tên | ★ | Cập nhật | Giấy phép | Ghi chú |
|---|---:|---|---|---|
| [VKey](https://github.com/phatMT97/VKey) | 175 | 🟢 2026-09 | GPL-3.0 | Bộ gõ Windows nguồn mở, build có ký số qua SignPath, cập nhật rất đều. |
...
| Tên | ★ | Cập nhật | Giấy phép | Ghi chú |
|---|---:|---|---|---|
| [IBus Bamboo](https://github.com/BambooEngine/ibus-bamboo) | 1497 | 🟢 2026-07 | GPL-3.0 | Bộ gõ IBus nhiều sao nhất Linux, nhưng tác giả tự nhận dự án đã đình trệ. |
| [Fcitx5 Lotus](https://lotusinputmethod.github.io/) | 476 | 🟢 2026-09 | GPL-3.0 | Fork từ VMK, gõ không để lại gạch chân preedit, hiện là bản Fcitx5 sống nhất. |
...
| [Fcitx5 Unikey](https://github.com/fcitx/fcitx5-unikey) | 129 | 🟢 2026-09 | GPL-2.0-or-later | Nhân Unikey cho Fcitx5; README ibus-bamboo khuyên chuyển sang nếu chạy Wayland. |
...
|---|---|---:|---|---|---|
| [OpenKey](https://open-key.org) | mac · win | 951 | 🟢 2026-06 | GPL-3.0 | Phổ biến nhất trên macOS, dùng kỹ thuật Backspace; bản cuối 2.0.5 từ 2022. |
| [VnKey](https://vnkey.app) | mac · win · linux | 102 | 🟢 2026-04 | GPL-3.0 | Viết Rust, đóng gói sẵn cho cả Fcitx5, IBus, deb/rpm/nixos. |
| [Funput](https://funput.app) | mac · win · linux | 27 | 🟢 2026-09 | MIT | Dùng chung một lõi cho mọi nền tảng, có cả bàn phím iOS/Android riêng. |
