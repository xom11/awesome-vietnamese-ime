...
Số liệu ★, lần push cuối và giấy phép do GitHub Action sinh lại hàng tuần từ [`data/ime.json`](data/ime.json). Vài giấy phép GitHub đọc không ra thì khai tay, có ghi rõ trong [CONTRIBUTING.md](CONTRIBUTING.md) (chốt lần cuối: 2026-08-24).
...
| Hệ điều hành | Gợi ý |
|---|---|
| macOS | 🟢 [Gõ Nhanh](https://gonhanh.org) 753★ · 🟢 [XKey](https://github.com/xmannv/xkey) 489★ |
...
| Linux | 🟢 [Fcitx5 Lotus](https://lotusinputmethod.github.io/) 461★ · 🟢 [IBus Bamboo](https://github.com/BambooEngine/ibus-bamboo) 1492★ · 🟢 [VnKey](https://vnkey.app) 103★ |
...
| [XKey](https://github.com/xmannv/xkey) | 489 | 🟢 2026-08 | MIT | Bộ gõ macOS viết Swift, nhiều tính năng: macro, từ điển, dịch nhanh 30+ ngôn ngữ. |
| [Gõkey](https://github.com/huytd/goxkey) | 281 | 🟢 2026-08 | BSD-3-Clause | Bộ gõ macOS viết Rust, tối giản, không có tính năng nào ngoài gõ tiếng Việt. |
...
| [VietTelex](https://viettelex.com) | 52 | 🟢 2026-08 | MIT | Input method IMKit thật của macOS, không gạch chân, gõ được cả trong Terminal. |
...
| [Fcitx5 Lotus](https://lotusinputmethod.github.io/) | 461 | 🟢 2026-08 | GPL-3.0 | Fork từ VMK, gõ không để lại gạch chân preedit, hiện là bản Fcitx5 sống nhất. |
...
| [Viet+](https://github.com/vndangkhoa/vietc) | 60 | 🟢 2026-07 | MIT | Gõ Linux qua uinput trực tiếp, không qua khung IBus/Fcitx, còn thử nghiệm. |
...
|---|---|---:|---|---|---|
| [OpenKey](https://open-key.org) | mac · win | 948 | 🟢 2026-06 | GPL-3.0 | Phổ biến nhất trên macOS, dùng kỹ thuật Backspace; bản cuối 2.0.5 từ 2022. |
| [VnKey](https://vnkey.app) | mac · win · linux | 103 | 🟢 2026-04 | GPL-3.0 | Viết Rust, đóng gói sẵn cho cả Fcitx5, IBus, deb/rpm/nixos. |
| [Funput](https://funput.app) | mac · win · linux | 22 | 🟢 2026-08 | MIT | Dùng chung một lõi cho mọi nền tảng, có cả bàn phím iOS/Android riêng. |
