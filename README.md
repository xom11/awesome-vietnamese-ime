...
| Hệ điều hành | Gợi ý |
|---|---|
| macOS | 🟢 [Gõ Nhanh](https://gonhanh.org) 748★ · 🟢 [XKey](https://github.com/xmannv/xkey) 485★ |
...
| Linux | 🟢 [Fcitx5 Lotus](https://lotusinputmethod.github.io/) 446★ · 🟢 [IBus Bamboo](https://github.com/BambooEngine/ibus-bamboo) 1490★ · 🟢 [VnKey](https://vnkey.app) 101★ |
...
| [XKey](https://github.com/xmannv/xkey) | 485 | 🟢 2026-07 | MIT | Bộ gõ macOS viết Swift, nhiều tính năng: macro, từ điển, dịch nhanh 30+ ngôn ngữ. |
...
| [PHTV](https://phamhungtien.com/PHTV/) | 163 | 🟢 2026-08 | AGPL-3.0 | Bộ gõ macOS chú trọng riêng tư, xử lý cục bộ, đang mở rộng sang Windows/Linux. |
...
| [VietTelex](https://viettelex.com) | 5 | 🟢 2026-08 | MIT | Input method IMKit thật của macOS, không gạch chân, gõ được cả trong Terminal. |
...
| Tên | ★ | Cập nhật | Giấy phép | Ghi chú |
|---|---:|---|---|---|
| [IBus Bamboo](https://github.com/BambooEngine/ibus-bamboo) | 1490 | 🟢 2026-07 | GPL-3.0 | Bộ gõ IBus nhiều sao nhất Linux, nhưng tác giả tự nhận dự án đã đình trệ. |
| [Fcitx5 Lotus](https://lotusinputmethod.github.io/) | 446 | 🟢 2026-08 | GPL-3.0 | Fork từ VMK, gõ không để lại gạch chân preedit, hiện là bản Fcitx5 sống nhất. |
...
|---|---|---:|---|---|---|
| [OpenKey](https://open-key.org) | mac · win | 944 | 🟢 2026-06 | GPL-3.0 | Phổ biến nhất trên macOS, dùng kỹ thuật Backspace; bản cuối 2.0.5 từ 2022. |
...
| Tên | Nền tảng | ★ | Cập nhật | Giấy phép | Ghi chú |
|---|---|---:|---|---|---|
| [vi-rs](https://github.com/ZeroX-DG/vi-rs) | mac · win · linux | 160 | 🟢 2026-06 | MIT | Thư viện Rust thuần xử lý dấu, không giao diện, để nhúng vào bộ gõ tự viết. |
