...
Số liệu ★, lần push cuối và giấy phép do GitHub Action sinh lại hàng tuần từ [`data/ime.json`](data/ime.json). Vài giấy phép GitHub đọc không ra thì khai tay, có ghi rõ trong [CONTRIBUTING.md](CONTRIBUTING.md) (chốt lần cuối: 2026-08-31).
...
| Hệ điều hành | Gợi ý |
|---|---|
| macOS | 🟢 [Gõ Nhanh](https://gonhanh.org) 753★ · 🟢 [XKey](https://github.com/xmannv/xkey) 492★ |
| Windows | 🟢 [VKey](https://github.com/phatMT97/VKey) 174★ · 📦 [VietType](https://github.com/dinhngtu/VietType) 55★ · ⚫ [UniKey](https://www.unikey.org) |
| Linux | 🟢 [Fcitx5 Lotus](https://lotusinputmethod.github.io/) 467★ · 🟢 [IBus Bamboo](https://github.com/BambooEngine/ibus-bamboo) 1492★ · 🟢 [VnKey](https://vnkey.app) 103★ |
...
|---|---:|---|---|---|
| [Gõ Nhanh](https://gonhanh.org) | 753 | 🟢 2026-08 | BSD-3-Clause | Bộ gõ macOS viết Rust, tối ưu <10ms độ trễ, tự nhớ chế độ gõ theo từng app. |
| [XKey](https://github.com/xmannv/xkey) | 492 | 🟢 2026-08 | MIT | Bộ gõ macOS viết Swift, nhiều tính năng: macro, từ điển, dịch nhanh 30+ ngôn ngữ. |
...
| [PHTV](https://phamhungtien.com/PHTV/) | 165 | 🟢 2026-08 | AGPL-3.0 | Bộ gõ macOS chú trọng riêng tư, xử lý cục bộ, đang mở rộng sang Windows/Linux. |
...
| [VietTelex](https://viettelex.com) | 54 | 🟢 2026-08 | MIT | Input method IMKit thật của macOS, không gạch chân, gõ được cả trong Terminal. |
| [UVieKey](https://github.com/thuupx/UVieKey) | 21 | 🟢 2026-08 | — | App macOS chính chủ của engine uvie-rs: nhấn Fn đổi Anh/Việt, có macro gõ tắt. |
...
| Tên | ★ | Cập nhật | Giấy phép | Ghi chú |
|---|---:|---|---|---|
| [VKey](https://github.com/phatMT97/VKey) | 174 | 🟢 2026-08 | GPL-3.0 | Bộ gõ Windows nguồn mở, build có ký số qua SignPath, cập nhật rất đều. |
...
| [Fcitx5 Lotus](https://lotusinputmethod.github.io/) | 467 | 🟢 2026-08 | GPL-3.0 | Fork từ VMK, gõ không để lại gạch chân preedit, hiện là bản Fcitx5 sống nhất. |
...
| [Fcitx5 Unikey](https://github.com/fcitx/fcitx5-unikey) | 129 | 🟢 2026-08 | GPL-2.0-or-later | Nhân Unikey cho Fcitx5; README ibus-bamboo khuyên chuyển sang nếu chạy Wayland. |
...
| [VMK](https://github.com/thanhpy2009/VMK) | 99 | 🟡 2026-02 | GPL-3.0 | Dựng trên fcitx5-bamboo, thêm cơ chế không gạch chân kiểu UniKey; alpha, đã dừng. |
...
| [Viet+](https://github.com/vndangkhoa/vietc) | 60 | 🟢 2026-08 | MIT | Gõ Linux qua uinput trực tiếp, không qua khung IBus/Fcitx, còn thử nghiệm. |
...
| [PinaKey](https://trananhtung.github.io/pinakey-web/) | 7 | 🟢 2026-08 | — | Lõi Rust thuần + addon C++ cho Fcitx5, gõ không gạch chân; repo chưa có giấy phép. |
...
|---|---|---:|---|---|---|
| [OpenKey](https://open-key.org) | mac · win | 950 | 🟢 2026-06 | GPL-3.0 | Phổ biến nhất trên macOS, dùng kỹ thuật Backspace; bản cuối 2.0.5 từ 2022. |
| [VnKey](https://vnkey.app) | mac · win · linux | 103 | 🟢 2026-04 | GPL-3.0 | Viết Rust, đóng gói sẵn cho cả Fcitx5, IBus, deb/rpm/nixos. |
| [Funput](https://funput.app) | mac · win · linux | 26 | 🟢 2026-08 | MIT | Dùng chung một lõi cho mọi nền tảng, có cả bàn phím iOS/Android riêng. |
| [VietIME](https://github.com/donamvn/viet-ime) | mac · win · linux | 10 | 🟢 2026-02 | — | Portable, không cần cài; bản mac/Linux có từ v1.0.8 nhưng còn thử nghiệm. |
...
| [uvie-rs](https://github.com/thuupx/uvie-rs) | mac · win · linux | 22 | 🟢 2026-08 | MIT OR Apache-2.0 | Thư viện Rust no_std/no-alloc, tối ưu độ trễ dưới micro-giây mỗi phím gõ. |
